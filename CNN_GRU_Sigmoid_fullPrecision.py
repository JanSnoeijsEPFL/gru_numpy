...
import model_sigmoid
from model_sigmoid import GRU
from model_sigmoid import Conv2D
from model_sigmoid import MaxPool2D
from model_sigmoid import sigmoid
from model_sigmoid import reLU
from model_sigmoid import tanh
from model_sigmoid import CrossEntropy
from model_sigmoid import Optimizer
from model_sigmoid import orthogonal_initializer
...
print("Reading files ", startfile+1, " to ", nb_files + startfile+1, "\n")
...
file2 = open("results/testfile16_sigmoid_lowPrecision_15TrainingFiles", 'w')
